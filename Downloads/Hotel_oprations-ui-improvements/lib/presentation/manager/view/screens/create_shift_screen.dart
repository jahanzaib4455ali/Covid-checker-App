...
class _CreateShiftScreenState extends State<CreateShiftScreen> {
  ...
  String selectedDate = "15-01-2025";
        ...
        child: Column(
          ...
          children: [
            ...
            _buildDropdownField(
              ...
              (value) => setState(() => selectedShiftType = value!),
            ),
            
            SizedBox(height: 20.h),
            
            _buildTimeField("Start Time", startTime, () => _selectTime(true)),
            
            SizedBox(height: 20.h),
            
            _buildTimeField("End Time", endTime, () => _selectTime(false)),
            
            SizedBox(height: 20.h),
            
            _buildDateField("Date", selectedDate, () => _selectDate()),
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                ...
                const Icon(Icons.access_time, color: MyColors.gray9F9F9F, size: 20),
              ],
            ),
          ),
        ),
