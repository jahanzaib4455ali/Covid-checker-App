...
class MenuContainer extends StatelessWidget {
  ...
  final bool inCart;
  final int quantity;
  const MenuContainer({super.key, required this.onAdd, required this.onRemove, this.inCart = false, this.quantity = 0});
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: () {
        // Pass onAdd so the bottom sheet can add to cart and update counts properly
        showFoodDetailBottomSheet(context, onAddItem: onAdd);
      },
      child: Container(
