...
class AmenitiesStockScreen extends StatelessWidget {
  const AmenitiesStockScreen({super.key});
  ...
  Widget _buildTable() {
    final List<Map<String, dynamic>> items = [
      {'name': 'Bath Towel', 'assigned': 5, 'refilled': 1, 'available': 2},
      {'name': 'Hand Towel', 'assigned': 8, 'refilled': 5, 'available': 3},
      {'name': 'Soap Bar\n250 ml', 'assigned': 4, 'refilled': 2, 'available': 4},
      {'name': 'Hand Sanitizer\n250 ml', 'assigned': 3, 'refilled': 1, 'available': 2},
      {'name': 'Shampoo\n50 ml', 'assigned': 5, 'refilled': 4, 'available': 1},
      {'name': 'Conditioner\n50 ml', 'assigned': 5, 'refilled': 0, 'available': 5},
    ];
    ...
    return Column(
      children: [
        ...
        Container(
          ...
          child: Row(
            children: [
              Expanded(flex: 3, child: _headerText('Amenities List', align: TextAlign.start)),
