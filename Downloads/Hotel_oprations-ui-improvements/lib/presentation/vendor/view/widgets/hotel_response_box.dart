...
class HotelResponse extends StatelessWidget {
  const HotelResponse({
    super.key,
    this.isPriceAgreed,
    this.isDispatchOrder,
  });

  final bool? isPriceAgreed;
  final bool? isDispatchOrder;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          if (isPriceAgreed == null && isDispatchOrder == null)
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                MyElevatedButton(
